...
#   https://github.com/NVIDIA/TensorRT-LLM/blob/main/tensorrt_llm/_torch/cute_dsl_kernels/blackwell/top_k/single_pass_multi_cta_radix_topk_cluster.py
...
class SinglePassMultiCTARadixTopKClusterKernel(SinglePassMultiCTARadixTopKKernel):
    ...
    def __init__(
        ...
        super().__init__(
            dtype, chunk_size, top_k, next_n, num_copy_bits, ctas_per_group, num_sms
        )
